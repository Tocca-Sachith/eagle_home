          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-300">
              ...
              <li className="flex items-start">
                ...
                <div>
                  <div className="text-xs text-gray-400 mb-1">{t('footer.followUs')}</div>
                  <div className="flex gap-3">
                    <a href="#" className="w-8 h-8 bg-gray-700 hover:bg-brand-gold rounded-full flex items-center justify-center transition-colors">
